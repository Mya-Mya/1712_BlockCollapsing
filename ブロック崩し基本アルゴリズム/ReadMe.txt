========================================================================
    コンソール アプリケーション: ブロック崩し基本アルゴリズム プロジェクトの概要
========================================================================

この ブロック崩し基本アルゴリズム アプリケーションは、AppWizard により作成されました。

このファイルには、ブロック崩し基本アルゴリズム アプリケーションを構成する各ファイルの内容の概要が含まれています。


ブロック崩し基本アルゴリズム.vcxproj
...
ブロック崩し基本アルゴリズム.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、ブロック崩し基本アルゴリズム.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
